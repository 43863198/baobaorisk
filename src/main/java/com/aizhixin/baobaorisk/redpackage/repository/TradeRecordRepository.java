...
public interface TradeRecordRepository extends JpaRepository<TradeRecord, String> {
    ...
    @Query("SELECT new com.aizhixin.baobaorisk.redpackage.vo.TradeRecordVO(t.id, t.tradeName, t.cashFee, t.discountFee, t.timeEnd, t.tradeType) FROM #{#entityName} t WHERE t.openId = :openId and t.deleteFlag = :deleteFlag")
